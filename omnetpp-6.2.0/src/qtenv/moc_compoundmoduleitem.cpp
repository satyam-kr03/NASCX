...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_omnetpp__qtenv__CompoundModuleItem_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_omnetpp__qtenv__CompoundModuleItem_t qt_meta_stringdata_omnetpp__qtenv__CompoundModuleItem = {
    {
        QT_MOC_LITERAL(0, 34)   // "omnetpp::qtenv::CompoundModul..."
    },
...
Q_CONSTINIT static const uint qt_meta_data_omnetpp__qtenv__CompoundModuleItem[] = {
...
Q_CONSTINIT const QMetaObject omnetpp::qtenv::CompoundModuleItem::staticMetaObject = { {
    ...
    qt_meta_stringdata_omnetpp__qtenv__CompoundModuleItem.offsetsAndSizes,
    qt_meta_data_omnetpp__qtenv__CompoundModuleItem,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_omnetpp__qtenv__CompoundModuleItem_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CompoundModuleItem, std::true_type>
    >,
    nullptr
} };
