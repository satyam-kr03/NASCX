...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_omnetpp__qtenv__GenericObjectTreeModel_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_omnetpp__qtenv__GenericObjectTreeModel_t qt_meta_stringdata_omnetpp__qtenv__GenericObjectTreeModel = {
    {
        QT_MOC_LITERAL(0, 38),  // "omnetpp::qtenv::GenericObject..."
        QT_MOC_LITERAL(39, 10),  // "dataEdited"
        QT_MOC_LITERAL(50, 0),  // ""
...
Q_CONSTINIT static const uint qt_meta_data_omnetpp__qtenv__GenericObjectTreeModel[] = {
...
Q_CONSTINIT const QMetaObject omnetpp::qtenv::GenericObjectTreeModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_omnetpp__qtenv__GenericObjectTreeModel.offsetsAndSizes,
    qt_meta_data_omnetpp__qtenv__GenericObjectTreeModel,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_omnetpp__qtenv__GenericObjectTreeModel_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<GenericObjectTreeModel, std::true_type>,
        // method 'dataEdited'
...
void omnetpp::qtenv::GenericObjectTreeModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GenericObjectTreeModel::dataEdited; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
