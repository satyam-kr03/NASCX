...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_omnetpp__qtenv__MessagePrinterTagsDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_omnetpp__qtenv__MessagePrinterTagsDialog_t qt_meta_stringdata_omnetpp__qtenv__MessagePrinterTagsDialog = {
    {
        QT_MOC_LITERAL(0, 40),  // "omnetpp::qtenv::MessagePrinte..."
        QT_MOC_LITERAL(41, 13),  // "onItemChanged"
        QT_MOC_LITERAL(55, 0),  // ""
...
Q_CONSTINIT static const uint qt_meta_data_omnetpp__qtenv__MessagePrinterTagsDialog[] = {
...
Q_CONSTINIT const QMetaObject omnetpp::qtenv::MessagePrinterTagsDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_omnetpp__qtenv__MessagePrinterTagsDialog.offsetsAndSizes,
    qt_meta_data_omnetpp__qtenv__MessagePrinterTagsDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_omnetpp__qtenv__MessagePrinterTagsDialog_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MessagePrinterTagsDialog, std::true_type>,
