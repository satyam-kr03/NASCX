...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_omnetpp__qtenv__OutputVectorInspector_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_omnetpp__qtenv__OutputVectorInspector_t qt_meta_stringdata_omnetpp__qtenv__OutputVectorInspector = {
    {
        QT_MOC_LITERAL(0, 37),  // "omnetpp::qtenv::OutputVectorI..."
        QT_MOC_LITERAL(38, 23),  // "onOptionsDialogTriggerd"
        QT_MOC_LITERAL(62, 0),  // ""
        QT_MOC_LITERAL(63, 28),  // "onCustomContextMenuRequested"
        QT_MOC_LITERAL(92, 3),  // "pos"
        QT_MOC_LITERAL(96, 12)   // "onClickApply"
    },
...
Q_CONSTINIT static const uint qt_meta_data_omnetpp__qtenv__OutputVectorInspector[] = {
...
Q_CONSTINIT const QMetaObject omnetpp::qtenv::OutputVectorInspector::staticMetaObject = { {
    ...
    qt_meta_stringdata_omnetpp__qtenv__OutputVectorInspector.offsetsAndSizes,
    qt_meta_data_omnetpp__qtenv__OutputVectorInspector,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_omnetpp__qtenv__OutputVectorInspector_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<OutputVectorInspector, std::true_type>,
        // method 'onOptionsDialogTriggerd'
