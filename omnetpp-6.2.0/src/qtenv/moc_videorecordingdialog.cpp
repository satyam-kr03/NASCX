...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_omnetpp__qtenv__VideoRecordingDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_omnetpp__qtenv__VideoRecordingDialog_t qt_meta_stringdata_omnetpp__qtenv__VideoRecordingDialog = {
    {
        QT_MOC_LITERAL(0, 36)   // "omnetpp::qtenv::VideoRecordin..."
    },
...
Q_CONSTINIT static const uint qt_meta_data_omnetpp__qtenv__VideoRecordingDialog[] = {
...
Q_CONSTINIT const QMetaObject omnetpp::qtenv::VideoRecordingDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_omnetpp__qtenv__VideoRecordingDialog.offsetsAndSizes,
    qt_meta_data_omnetpp__qtenv__VideoRecordingDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_omnetpp__qtenv__VideoRecordingDialog_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<VideoRecordingDialog, std::true_type>
    >,
    nullptr
} };
