...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_omnetpp__qtenv__WatchInspector_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_omnetpp__qtenv__WatchInspector_t qt_meta_stringdata_omnetpp__qtenv__WatchInspector = {
    {
        QT_MOC_LITERAL(0, 30),  // "omnetpp::qtenv::WatchInspector"
        QT_MOC_LITERAL(31, 6),  // "commit"
        QT_MOC_LITERAL(38, 0)   // ""
    },
...
Q_CONSTINIT static const uint qt_meta_data_omnetpp__qtenv__WatchInspector[] = {
...
Q_CONSTINIT const QMetaObject omnetpp::qtenv::WatchInspector::staticMetaObject = { {
    ...
    qt_meta_stringdata_omnetpp__qtenv__WatchInspector.offsetsAndSizes,
    qt_meta_data_omnetpp__qtenv__WatchInspector,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_omnetpp__qtenv__WatchInspector_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<WatchInspector, std::true_type>,
        // method 'commit'
