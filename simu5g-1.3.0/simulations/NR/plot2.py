...
def main():
    ...
    results_new = base_dir / "xr_experimental_2.5ms/comparison/comparison_results_pca"
    results_small = base_dir / "xr_experimental_5ms/comparison/comparison_results_pca"
...
# 1. MAKE IT SHORTER: Change height from 2.8 to 2.2 for a sleeker, wider look
    ...
    plot_grouped_bar_on_ax(axes[0], df_new, "Delay Bound = 2.5 ms", add_legend=False)
    plot_grouped_bar_on_ax(axes[1], df_small, "Delay Bound = 5 ms", add_legend=False)
