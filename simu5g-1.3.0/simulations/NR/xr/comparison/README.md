...
This document describes the comparative evaluation pipeline executed by `run_comparison.py`.
...
- Generates a simulation run directory structure under `comparison_results/`.
...
Additionally, the comparison output includes diagnostic fields:
...
### 1. CSV Database
The comprehensive multi-axis outcomes are exported to `comparison_results/comparison.csv`, enabling further graph plotting or deep-dive analysis.
