...
from constants import RANDOM_SEED, DEFAULT_TRAIN_RATIO, DEFAULT_COMPONENTS, DEFAULT_MAX_COMPONENTS, DEFAULT_IMG_SIZE
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path("/home/teaching/Projects/NASCX/data/yt360-videos/cruella.mp4"),
    ...
    parser.add_argument(
        ...
        default=Path("traffic_files/pca/pca_sweep_summary_cruella.csv"),
